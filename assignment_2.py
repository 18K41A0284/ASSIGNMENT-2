...
Original file is located at
    https://colab.research.google.com/drive/1X5BSAPUSd89HKr2AcVGXyWeThdy8epoA

1.
Area of Triangle : Given the lengths of three sides of a triangle, calculate the area of the triangle.
"""
...
x=int(input('enter year you want to check : '))
if x%4==0:
...
str1 = input("enter list of words with commas : ")
b=[b for b in str1.split(",")]
...
for i in l:
  r*=i
  print("multiplaction of all elements :",r)
